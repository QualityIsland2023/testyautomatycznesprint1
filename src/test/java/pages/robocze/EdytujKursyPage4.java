...
import java.util.List;
 ...
 public class EdytujKursyPage4 {
    ...
    public EdytujKursyPage4(WebDriver driver){
        this.driver = driver;
    ...
    int poprawnaIloscSekcjiPodstawowe = 8;
     ...
     @FindBy(xpath = "//ul[@class,'settings-nav-tab']/li/a")
    ...
    //przejście do zakładki kursy w menu bocznym
     ...
     //pobranie tekstu 'Edycja kursu:'
//     public Boolean pobranieTekstuSekcjiEdycjaKursu(){
//         boolean status = false;
//         if(driver.getPageSource().contains("Edycja kursu:")){
//             status = true;
...
//     public Boolean sprawdzenieWidocznosciSekcjiEdycjaKursu(){
//        boolean status = false;
//        if(edycjaKursu.isDisplayed()){
//            status = true;
//            System.out.println("Okno 'Edycja kursu' jest widoczne.");
//        }
//        return status;
//     }
     ...
     public Boolean sprawdzenieWidocznosciSekcjiEdycjaKursu(){
         boolean status = false;
         if(wait.waitForVisibility(edycjaKursu).isDisplayed()){
             status = true;
             System.out.println("Okno 'Edycja kursu' jest widoczne.");
         }
         return status;
