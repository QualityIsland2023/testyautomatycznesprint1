...
public class EdytujKursyPageTest4 extends TestBase {
...
//        Assert.assertTrue(edytujKursyPage.pobranieTekstuSekcjiEdycjaKursu(),"Okno 'Edycja kursu' nie jest widoczne.");
//        Assert.assertTrue(edytujKursyPage.sprawdzenieWidocznosciSekcjiEdycjaKursu(), "Okno 'Edycja kursu' nie jest widoczne.");
    }
    ...
    public void weryfikacjaLiczbyPozycjiWMenuBocznymOknaEdycjaKursow() {
        ...
        Assert.assertEquals(edytujKursyPage.zworcLiczbePozycjiWMenuBocznymOknaEdycjaKursow(),edytujKursyPage.zwrocPoprawnaLiczbePozycjiWMenuBocznymOknaEdycjaKursow(),"W oknie 'Edycja kursu' nie znaleziono 3 zakładek menu bocznego");
    ...
    public void weryfikacjaNazwyPozycjiWMenuBocznymOknaEdycjaKursow() {
        ...
        Assert.assertEquals(edytujKursyPage.zwrocNazwyPozycjiMenuBocznymOknaEdycjaKursow(),edytujKursyPage.zwrocPoprawneNazywyPozycjiOknaEdycjaKursow(),"W oknie 'Edycja kursu' nie znaleziono odpowiednich zakładek menu bocznego");
    ...
    public void weryfikacjaLiczbySekcjiPodstawoweWMenuBocznymOknaEdycjaKursow() {
        ...
        Assert.assertEquals(edytujKursyPage.zworcLiczbeSekcjiPodstawoweWMenuBocznymOknaEdycjaKursow(),edytujKursyPage.zwrocPoprawnaLiczbeSekcjiPodstawoweWMenuBocznymOknaEdycjaKursow(),"W oknie 'Edycja kursu', w zakładce 'Podstawowe' nie znaleziono 8 sekcji");
    }
    // Test weryfikujący, czy w oknie 'Edycja kursu' w zakładce 'Podstawowe' znajdują się oczekiwane sekcje.
    @Test(priority = 41, enabled = true, description = "Weryfikacja istnienia oczekiwanych sekcji zakładki 'Podstawowe'.")
    public void weryfikacjaSekcjiZakladkiPodstawoweWMenuBocznymOknaEdycjaKursow() {
        ...
        Assert.assertEquals(edytujKursyPage.zwrocNazwySekcjiZakladkiPodstawoweWMenuBocznymOknaEdycjaKursow(),edytujKursyPage.zwrocPoprawneNazywySekcjiZakladkiPodstawoweWMenuBocznymOknaEdycjaKursow(),"W oknie 'Edycja kursu', a w zakaładce 'Podstawowe' nie znaleziono odpowiednich sekcji");
    }
}