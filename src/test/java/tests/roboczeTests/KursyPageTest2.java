...
public class KursyPageTest2 extends TestBase {
...
//        kursyPage.sprawdzPolaNazwaKursuICena2();
...
//        Assert.assertTrue(kursyPage.sprawdzCzyPoleNazwaKursuIstnieje() &&
//                        kursyPage.sprawdzCzyPoleCenaIstnieje(),
//                kursyPage.pobierzKomunikat());

//        Assert.assertEquals(kursyPage.sprawdzCzyPoleNazwaKursuIstnieje(),kursyPage.sprawdzCzyPoleCenaIstnieje(),"Pola 'Nazwa kursu' i 'Cena' nie są poprawnie wyświetlone i aktywne.");
    }

    // Test weryfikujący, czy w oknie 'Utwórz nowy kurs' znajdują się przycisk 'Utwórz i edytuj'.
    @Test(priority = 60, enabled = true, description = "Weryfikacja, czy w oknie 'Utwórz nowy kurs' znajdują się przycisk 'Utwórz i edytuj'.")
