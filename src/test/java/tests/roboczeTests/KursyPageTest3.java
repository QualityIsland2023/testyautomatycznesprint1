...
public class KursyPageTest3 extends TestBase {
...
//        Assert.assertEquals(kursyPage.sprawdzCzyPoleNazwaKursuIstnieje(),kursyPage.sprawdzCzyPoleCenaIstnieje(),"Pola 'Nazwa kursu' i 'Cena' nie są poprawnie wyświetlone i aktywne.");
    ...
    public void weryfikacjaPrzyciskuUtworzIEdytuj() {
        ...
        Assert.assertTrue(kursyPage.sprawdzCzyPrzyciskUtworzIEdytujIstnieje(),"Przycisk 'Utwórz i edytuj' nie jest wyświetlony i/lub aktywny.");
    }
}
